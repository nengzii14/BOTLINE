    ...
    try:
        if msg.toType == 0:
            if msg.contentType == 0:
                ...
                if msg.text == "me":
                    sendMessage(msg.to, text=None, contentMetadata={'mid': msg.from_}, contentType=1)
                if msg.text == "gift":
        ...
        if msg.toType == 2:
            if msg.contentType == 0:
                ...
                if msg.text == "gift":
                    sendMessage(msg.to, text="gift sent", contentMetadata=None, contentType=9)
                if msg.text == "นับ":
                    sendMessage(msg.to, "♪ระบบ...เริ่มนับจำนวนคนแอบอ่านแล้ว ♪")
                    try:
                ...
                if msg.text == "อ่าน":
                    if msg.to in wait['readPoint']:
                        ...
                        sendMessage(msg.to, "นี้ไงรายชื่อคนอ่านทั้งหมด %s\nthat's it\n\nรายชื่อของคนที่ไม่ได้อ่านในตอนนี้\n%sIt is abnormal ♪\n\nReading point creation date n time:\n[%s]"  % (wait['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
